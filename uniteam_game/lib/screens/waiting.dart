...
enum WaitingRoomState { none, inRoomNotReady, inRoomReady, inGame }
...
class WaitingRoom extends StatelessWidget {
  ...
  final WaitingRoomState roomState;
  final String? email, name, roomId;
  final void Function(
    String roomId,
  ...
  Widget build(BuildContext context) {
    switch (roomState) {
          ...
          children: [
            JoinRoomForm(callback: (roomId) {
              joinRoom(
                  roomId,
                  (e) => _showErrorDialog(
                      context, 'Failed to enter room' + roomId, e));
            })
          ],
        );
      // case WaitingRoomState.password:
      //   return PasswordForm(
      //     email: email!,
      ...
      //     },
      //   );
      // case WaitingRoomState.register:
      //   return RegisterForm(
      //     email: email!,
      //     cancel: () {
      //       cancelRegistration();
      ...
      //     },
      //   );
      // case WaitingRoomState.loggedIn:
      //   return Row(
      //     children: [
      //       Padding(
